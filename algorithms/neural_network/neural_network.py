...
from .activation_functions import sigmoid, relu, sigmoid_backward, relu_backward
from .data_types import LinearForwardCache, Cache, Activation

class NeuralNetwork:
    def __init__(self, layer_dimensions: List[int]=[25,16,16,1],learning_rate:float=0.00001):
        """
        Parameters
        ----------
    ...
    def _linear_forward(self, A: ndarray, W: ndarray, b: ndarray) -> Tuple[ndarray, LinearForwardCache]:
        """
    ...
    def compute_cost(self, predictions: ndarray, y: ndarray) -> float:
        """
    ...
    def _linear_backward(self, dZ: ndarray, cache: LinearForwardCache) -> Tuple[ndarray, ndarray, ndarray]:
        """
    ...
    def _back_propagation(self, dA: ndarray, cache: Cache, activation: Activation) -> Tuple[ndarray, ndarray, ndarray]:
        """
    ...
    def back_propagation(self, predictions: ndarray, Y: ndarray, caches: List[Cache]):
        """
    ...
    def fit(self,X, Y, epochs=2000, print_cost=False):
        """
